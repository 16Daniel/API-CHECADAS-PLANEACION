...
namespace API_PEDIDOS.Jobs
{
    ...
    public class QuartzHostedServiceMermasAla : IHostedService
    {
        private readonly IScheduler _scheduler;

        public QuartzHostedServiceMermasAla(IScheduler scheduler)
        {
    ...
    public class JobEmailMermasAla : IJob
    {
        ...
        public JobEmailMermasAla(ILogger<JobEmail> logger, BD2Context db2c, DBPContext dbpc, IConfiguration configuration)
        {
            _logger = logger;
            _dbpContext = dbpc;
            _contextdb2 = db2c;
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            string storedProcedureName = "JOBEMAIL_MERMAS_ALA";
        ...
        static void EnviarCorreo(string bodymail, string nombremes)
        {
            ...
            string asunto = "❌ IT: MERMAS ALA DE POLLO FRESCA " + nombremes;
